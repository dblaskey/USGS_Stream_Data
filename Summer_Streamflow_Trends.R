...
Summer <- final %>%
  filter(11 > as.numeric(Month) &  7 < as.numeric(Month))

wd <- Summer %>%
  count(site_no, Year) %>%
  filter(n<Pcriteria)

final <- anti_join(Summer, wd) 
...
#Summer mean discharge
qy_mean <- final %>%
  group_by(site_no, Year) %>%
  summarise(Annual_Mean_Discharge = mean(X_00060_00003)) %>%
  drop_na()

#Summer discharge statistical analysis
p_val <- 0.1
...
ggplot() + 
  ...
  labs(title="Percent Change in Summer Months Mean Discharge", color=" ") +
  ...
  scale_colour_gradient2(name = "Percent Change\nPer Decade") +
...
ggplot() + 
  ...
  labs(title="Percent Change in Summer Months Median Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
ggplot() + 
  ...
  labs(title="Percent Change in Summer Months 90th Percentile Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
ggplot() + 
  ...
  labs(title="Percent Change in Summer Months 10th Percentile Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
ggplot() + 
  ...
  labs(title="Percent Change in Summer Months Maximum Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
ggplot() + 
  ...
  labs(title="Change in Flashiness of Streamflow during Summer Months", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
