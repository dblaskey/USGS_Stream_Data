...
Fall <- final %>%
  filter(12 > as.numeric(Month) &  8 < as.numeric(Month))

wd <- Fall %>%
  count(site_no, Year) %>%
  filter(n<Pcriteria)

final <- anti_join(Fall, wd) 
...
#Fall discharge statistical analysis
p_val <- 0.1
...
ggplot() + 
  ...
  labs(title="Percent Change in Fall Mean Discharge", color=" ") +
...
ggplot() + 
  ...
  labs(title="Percent Change in Fall Median Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
ggplot() + 
  ...
  labs(title="Percent Change in Fall 90th Percentile Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
ggplot() + 
  ...
  labs(title="Percent Change in Fall 10th Percentile Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
ggplot() + 
  ...
  labs(title="Percent Change in Fall Maximum Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
