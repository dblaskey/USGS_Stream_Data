...
start_year <- as.POSIXct("1988-09-30")
...
Warm <- final %>%
  filter(11 > as.numeric(Month) &  4 < as.numeric(Month))

wd <- Warm %>%
  count(site_no, Year) %>%
  filter(n<Pcriteria)

final <- anti_join(Warm, wd) 
...
#Warm discharge statistical analysis
p_val <- 0.1
...
ggplot() + 
  ...
  labs(title="Percent Change in Warm Months Mean Discharge", color=" ") +
...
ggplot() + 
  ...
  labs(title="Percent Change in Warm Months Median Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
ggplot() + 
  ...
  labs(title="Percent Change in Warm Months 90th Percentile Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
ggplot() + 
  ...
  labs(title="Percent Change in Warm Months 10th Percentile Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
ggplot() + 
  ...
  labs(title="Percent Change in Warm Months Maximum Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
ggplot() + 
  ...
  labs(title="Change in Flashiness of Streamflow during Warm Months", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
