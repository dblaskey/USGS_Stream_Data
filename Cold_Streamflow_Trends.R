...
Melt <- final %>%
  filter(10 < as.numeric(Month) | 5 > as.numeric(Month))
...
ggplot() + 
  ...
  labs(title="Percent Change in Cold Months Mean Discharge", color=" ") +
...
ggplot() + 
  ...
  labs(title="Relative Change in Cold Months Median Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
ggplot() + 
  ...
  labs(title="Relative Change in Cold Months 90th Percentile Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
ggplot() + 
  ...
  labs(title="Relative Change in Cold Months 10th Percentile Discharge", color=" ") +
  theme(plot.title = element_text(hjust = 0.5), axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), axis.title.y=element_blank(),
        axis.text.y=element_blank(),
